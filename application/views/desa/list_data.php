  ...
  foreach ($dataDesa as $desa) {
    ...
    <tr>
      ...
      <td class="text-center" style="min-width:230px;">
          ...
          <button class="btn btn-danger konfirmasiHapus-desa" data-id="<?php echo $desa->id; ?>" data-toggle="modal" data-target="#konfirmasiHapus"><i class="glyphicon glyphicon-remove-sign"></i> </button>
