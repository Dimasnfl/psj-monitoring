...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Apr 2022 pada 08.49
...
CREATE TABLE `tipe_produk` (
  ...
  `perubahan_tanggal` datetime DEFAULT NULL ON UPDATE current_timestamp(),
...
INSERT INTO `tipe_produk` (`id`, `foto`, `nama`, `harga`, `tanggal`, `perubahan_tanggal`, `terbaru`) VALUES
(3, 'cabai.png', 'Cabai', 30000, '2022-03-20', NULL, 1),
(4, 'jagung.png', 'Jagung', 25000, '2022-03-20', NULL, 1),
(6, 'kubis.png', 'Kubis', 10000, '2022-03-20', NULL, 1),
(7, 'singkong.png', 'Singkong', 15000, '2022-03-20', NULL, 1),
(8, 'mentimun.png', 'Timun', 20000, '2022-03-20', NULL, 1),
(9, 'tomat.png', 'Tomat', 20000, '2022-03-20', NULL, 1),
(10, 'bawang merah.png', 'Bawang Merah', 15000, '2022-03-20', NULL, 1),
(11, 'wortel.png', 'Wortel', 15000, '2022-03-20', NULL, 1),
(12, 'kentang.png', 'Kentang', 10000, '2022-03-20', NULL, 1),
(16, 'selada.png', 'selada', 20000, '2022-03-27', NULL, 1),
(21, 'cabai.png', 'cabai', 500002, '0000-00-00', NULL, 0);
