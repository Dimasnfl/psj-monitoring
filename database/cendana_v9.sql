...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2022 at 02:54 PM
...
INSERT INTO `produk` (`id`, `id_user`, `foto`, `tgl_tanam`, `tgl_panen`, `berat_panen`, `id_tipe_produk`, `alamat`, `status_produk_id`, `created_at`, `updated_at`) VALUES
(1, 1, 'asdasd', '2022-03-01', '2022-03-31', 122, 10, 'asdasd', 1, '2022-03-30 12:54:01', NULL);
...
(1, '3522456512362123', 'md5(password)', 'yusuf', '08563604240', 1, 'no', 'asdasdasd', '123456');
